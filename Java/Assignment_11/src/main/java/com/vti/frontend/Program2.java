...
import com.vti.backend.entity.Account;
...
public class Program2 {
	...
	private static void createAccount() throws Exception {
		...
		String email = ScannerUntils.inputString("Please input email as String!");

		System.out.println("Input username: ");
		String username = ScannerUntils.inputString("Please input username as String!");

		System.out.println("Input full name: ");
		String fullName = ScannerUntils.inputString("Please input full name as String!");
